...
const testimonials = [
  {
    name: 'Customer 1',
    role: 'Verified Buyer',
    quote: 'E-Store has an amazing selection of products and their customer service is top-notch!',
    image: T1,
  },
  {
    name: 'Customer 2',
    role: 'Regular Customer',
    quote: 'I love shopping at E-Store. The site is user-friendly and the delivery is always prompt.',
    image: T2,
  },
  {
    name: 'Customer 3',
